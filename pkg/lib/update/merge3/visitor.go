...
type Visitor struct {
	...
	// do not explicitly clear TaggedNull nodes
	KeepTaggedNull bool
}

func (v *Visitor) VisitMap(nodes walk.Sources, _ *openapi.ResourceSchema) (*yaml.RNode, error) {
...
func (v *Visitor) visitAList(nodes walk.Sources, _ *openapi.ResourceSchema) (*yaml.RNode, error) {
...
func (v *Visitor) VisitList(nodes walk.Sources, s *openapi.ResourceSchema, kind walk.ListKind) (*yaml.RNode, error) {
	if kind == walk.AssociativeList {
		return v.visitAList(nodes, s)
	}
	// non-associative list
	return v.visitNAList(nodes)
}

func (v *Visitor) getStrValues(nodes walk.Sources) (strValues, error) {
